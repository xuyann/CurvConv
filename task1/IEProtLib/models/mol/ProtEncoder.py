...
class ProtEncoder:
    ...
    def __create_molconv_resnet_model__(self,
        ...
        for curLevel in range(numLevels):
            ...
            # Create the blocks.
            curFeatures = self.convBuilder_.create_molconv_resnet_blocks(curlevel=curLevel, 
                ...
                pNumBasis = pNumBasis,
                pAtomDropOut = pAtomDropOut,protein=protein)
