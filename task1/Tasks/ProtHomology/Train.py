...
class ProtClassTrainLoop(TrainLoop):
    ...
    def __create_model__(self):
        ...
        if self.balance_:
            self.lossWeights_ = tf.compat.v1.placeholder(tf.float32, [1195])
    ...
    def __train_one_epoch__(self, pNumEpoch):
        ...
        for curBatch in range(numBatchesTrain):
            ...
            #Get the batch data.
            protBatch, features, labels, _, validProts = self.trainDS_.get_next_batch(0,
    ...
    def __test_one_epoch__(self, pNumEpoch):
        ...
        for curBatch in range(numBatchesTest):
            ...
            #Get the batch data.
            protBatch, features, labels, _, validProts = self.testDS_.get_next_batch(4,self.batchSize_)
